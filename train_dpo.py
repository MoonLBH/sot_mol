...
from sot_mol.models.dpo_interface import MolGen_DPOModel


parser = arg.ArgumentParser(description="DPO fine-tuning quick test")
...
model.Train(
    ...
    project_name="SOTMOL_DPO_QED_TEST",
