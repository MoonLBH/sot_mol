...
objective_config = {"aggregate": "official" if objective_name != "qed" else "geometric", "use_official_guacamol": True, "fallback_aggregate": "geometric", "feasibility": {"valid": True, "connected": True}}
partition_config = {"mode": args.partition_mode, "top_ratio": 0.25, "bottom_ratio": 0.25, "pareto_rank_max": 1, "top_candidate_quantile": 0.7, "diversity_mode": "scaffold", "bottom_mode": "unusable_region", "bottom_priority": ["invalid", "severe", "dominated", "low_score"], "bad_rank_quantile": 0.75, "low_score_quantile": 0.25}
